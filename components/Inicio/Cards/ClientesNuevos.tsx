...
export function ClientesNuevos({ clientes }: Props) {
    ...
    return (
        <div className="relative bg-gradient-to-br from-green-400 via-green-500 to-green-700 text-white p-6 rounded-2xl shadow-xl w-60 h-40 flex flex-col justify-center items-center overflow-hidden border-2 border-green-200">
            ...
            <h3 className="text-xl font-bold tracking-wide drop-shadow mb-2 z-10">Clientes nuevos este mes</h3>
