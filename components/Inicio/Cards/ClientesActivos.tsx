...
export function ClientesActivos({ clientes }: Props) {
  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-400 via-blue-500 to-blue-700 text-white p-6 rounded-2xl shadow-xl w-60 h-40 flex flex-col justify-center items-center overflow-hidden border-2 border-blue-200">
